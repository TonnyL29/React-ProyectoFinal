  ...
  return (
    <div>
      <div className="mb-3">
        ...
        <input type="text" className="form-control" placeholder="Jose Lopez" onInput={(e) =>{
            setNombre(e.target.value)}}/>
      </div>
      <div className="mb-3">
        <label htmlFor="Email" className="form-label">Email</label>
        <input type="email" className="form-control" placeholder="name@example.com" onInput={(e) =>{
            setEmail(e.target.value)}}/>
      </div>
      <div className="mb-3">
        <label htmlFor="Telefono" className="form-label">Telefono</label>
        <input type="text" className="form-control" placeholder="1122334455" onInput={(e) =>{
            setTelefono(e.target.value)}}/>
      </div>
      <div className="d-flex flex-row-reverse">
          <button
            type="button" className="btn btn-primary mb-3 mt-2" >
            Enviar pedido
          </button>
        </div>
    </div>
